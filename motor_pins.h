...
#endif
#define C_STEP_PORT         M4_STEP_PORT
#define C_STEP_PIN          M4_STEP_PIN
#define C_STEP_BIT          (1<<M4_STEP_PIN)
#define C_DIRECTION_PORT    M4_DIRECTION_PORT
#define C_DIRECTION_PIN     M4_DIRECTION_PIN
#define C_DIRECTION_BIT     (1<<M4_DIRECTION_PIN)
#ifdef M4_LIMIT_PIN
  #define C_LIMIT_PORT      M4_LIMIT_PORT
  #define C_LIMIT_PIN       M4_LIMIT_PIN
  #define C_LIMIT_BIT       (1<<M4_LIMIT_PIN)
#endif
#ifdef M4_LIMIT_PIN_MAX
  #define C_LIMIT_PORT_MAX  M4_LIMIT_PORT_MAX
  #define C_LIMIT_PIN_MAX   M4_LIMIT_PIN_MAX
  #define C_LIMIT_BIT_MAX   (1<<M4_LIMIT_PIN_MAX)
#endif
#ifdef M4_ENABLE_PIN
  #define C_ENABLE_PORT     M4_ENABLE_PORT
  #define C_ENABLE_PIN      M4_ENABLE_PIN
  #define C_ENABLE_BIT      (1<<M4_ENABLE_PIN)
#endif
#endif
...
#elif N_AXIS == 5
#define STEP_MASK (X_STEP_BIT|Y_STEP_BIT|Z_STEP_BIT|A_STEP_BIT|C_STEP_BIT)
#elif N_AXIS == 6
...
#elif N_AXIS == 5
#define DIRECTION_MASK (X_DIRECTION_BIT|Y_DIRECTION_BIT|Z_DIRECTION_BIT|A_DIRECTION_BIT|C_DIRECTION_BIT)
#elif N_AXIS == 6
...
#elif N_AXIS == 5
#define STEPPERS_ENABLE_MASK (X_ENABLE_BIT|Y_ENABLE_BIT|Z_ENABLE_BIT|A_ENABLE_BIT|C_ENABLE_BIT)
#elif N_AXIS == 6
...
#elif N_AXIS == 5
#define LIMIT_MASK (LIMIT_MASK_BASE|A_LIMIT_BIT|C_LIMIT_BIT)
#define LIMIT_MASK_SUM (LIMIT_MASK_BASE_SUM+A_LIMIT_BIT+C_LIMIT_BIT)
#elif N_AXIS == 6
